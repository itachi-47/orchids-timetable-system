...
export default async function CoordinatorCreateFacultyPage() {
    ...
    <CoordinatorLayout user={user}>
      <div className="mx-auto max-w-2xl space-y-6">
        <div>
          ...
          <p className="mt-1 text-slate-600">Add a new faculty member</p>
        </div>

        <FacultyForm mode="create" isAdmin={false} />
      </div>
    </CoordinatorLayout>
  )
}
