...
import { CheckCircle, Clock, XCircle, Calendar, Users, FileText, Send } from 'lucide-react'
...
const stats = [
  {
    ...
    description: 'Timetables waiting for your review',
    href: '/hod/approvals',
    icon: Clock,
    gradient: 'from-amber-500 to-amber-600',
  },
  {
    title: 'Approved Timetables',
  ...
  {
    title: 'Rejected',
    description: 'Previously rejected timetables',
    href: '/hod/rejected',
    icon: XCircle,
  ...
  },
  {
    ...
    description: 'View live timetables',
    href: '/hod/published',
    icon: Send,
  ...
  },
  {
    ...
    description: 'View current timetables',
    href: '/hod/timetable',
    icon: Calendar,
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-1 text-slate-600 dark:text-slate-400">
              Review and approve timetables submitted by coordinators
            </p>
          </div>
