...
export function GenerateTimetableForm() {
  ...
  return (
    <div className="space-y-6">
      <Card className="border-slate-700 bg-slate-800/50 backdrop-blur">
        <CardHeader>
          <CardTitle className="text-slate-50">Subject-Faculty Mapping</CardTitle>
          <CardDescription className="text-slate-400">
        ...
        <CardContent className="space-y-6">
          {subjects.map(subject => (
            <div key={subject.id} className="space-y-3 rounded-lg border border-slate-700 bg-slate-900/50 p-4">
              <div>
        ...
        <Card className="border-green-500/30 bg-green-500/10 backdrop-blur">
          <CardContent className="pt-6">
            <div className="space-y-2 text-sm text-green-300">
              ...
              <p className="text-xs text-green-400">Redirecting to timetable view...</p>
            </div>
          </CardContent>
        </Card>
      )}
