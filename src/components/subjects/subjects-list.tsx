          ...
          <Card key={subject.id} className="border-slate-200 bg-white shadow-sm">
            ...
            <CardContent className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs text-slate-600">
                <div>Credits: <span className="text-slate-700">{subject.credits}</span></div>
                <div>Theory: <span className="text-slate-700">{subject.theory_hours}h</span></div>
                <div>Practical: <span className="text-slate-700">{subject.practical_hours}h</span></div>
                <div>Total: <span className="text-slate-700">{subject.theory_hours + subject.practical_hours}h</span></div>
              </div>
            </CardContent>
          </Card>
        ))}
